...
public class main05 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String filePath_mini = "./SP22HW6/Inputs/MinimumSyntax-1-ASP22.txt";
        String filePath_bad1 = "./SP22HW6/Inputs/BadSyntax-1-ASP22.txt";
        String filePath_bad2 = "./SP22HW6/Inputs/BadSyntax-2-ASP22.txt";
        String filePath_good = "./SP22HW6/Inputs/GoodSyntax-1-ASP22.txt";
