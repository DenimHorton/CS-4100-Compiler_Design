 ...
 * @version 3.0
 * 
 * This File contains our interprtor object that will interpet
 * the programs "machine like" instructions.
 * 
 * Thoughts/Comments:
 * Possibly on next assignment crate method instead of storing 
 * functionality inside the if statments? 
 */
import java.io.File;
        ...
        */
        ...
        while (program_counter < MAXQUAD){
            ...
            // as value of op3.
                ...
                } while (input_value < 0 && input_value 
                        > this.optable.rsrv_table_index);    
                keyboard.close();
