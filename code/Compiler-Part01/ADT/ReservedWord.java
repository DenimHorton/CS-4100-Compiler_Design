 ...
 * 
 * This File represents the data object that will represent the specific 'name'
 * or reserved word that will stored with a specific 'op code' integer value.
 */
...
public class ReservedWord {
     ...
     * for the word being reserved represented as an integer. 
    */

    public String reserved_word;
    public int reserved_word_code;

    ReservedWord(String word_to_reserve, int word_to_reserve_code) {
        /**
    ...
    public void set_code(int word_to_reserve_code) {
        ...
        * integer value that is specific to the word's String representation 
        * or 'name'.
        */
        this.reserved_word_code = word_to_reserve_code;
    }
